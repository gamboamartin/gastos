...
class controlador_gt_proveedor extends system {
    ...
    public function proveedor_datos_generales(bool $header, bool $ws = false, string $breadcrumbs = '', bool $aplica_form = true,
    ...
    public function proveedor_datos_contactos(bool $header, bool $ws = false, string $breadcrumbs = '', bool $aplica_form = true,
                                       bool $muestra_btn = true): array|string
    {
        $r_modifica =  parent::modifica($header, $ws, $breadcrumbs, $aplica_form, $muestra_btn); // TODO: Change the autogenerated stub
        if(errores::$error){
