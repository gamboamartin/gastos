...
<tr>
    ...
    <th data-breakpoints="xs sm md"  data-type="html">Datos Fiscales</th>
    <th data-breakpoints="xs sm md"  data-type="html">Pagina Web</th>
    <th data-breakpoints="xs sm md"  data-type="html">Tipo Proveedor</th>
