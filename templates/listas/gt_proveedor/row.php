...
<tr>
    ...
    <td>
        <a href="./index.php?seccion=gt_proveedor&accion=ver_datos_fiscales&registro_id=<?php echo $row->gt_proveedor_id; ?>&session_id=<?php echo $controlador->session_id; ?>" class="btn btn-info"><i class="glyphicon glyphicon-eye-open"></i>
            Ver datos fiscales
        </a>
    </td>
    <td>
